# Telegramda yani ben boş işler müdürü :) <> @akillanmazkral Tarafından düzenlenen ufak çaplı proje. 
import os
import requests
import aiohttp
import yt_dlp
...
def bul(client, message):
    ...
    try:
        ...
        rep = f"▶️ **Şarkı**: [{title[:35]}]({link})\n⏳ **Süre**: `{duration}`\n•> [şarkilardan 𝖬𝗎𝗓𝗂𝗄 𝖡𝗈𝗍](https://t.me/Sarkilardankesitlerimusicbot) 𝖳𝖺𝗋𝖺𝖿𝗂𝗇𝖽𝖺𝗇 !"
